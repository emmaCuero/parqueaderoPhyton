...
def salida(parqueaderoCarro, parqueaderoMoto, vehiculos):
    ...
    horaSalida = datetime.now().strftime("%Y-%m-%d %H:%M:%S")
    ...
    # Verificar si el vehículo está alquilado
    if estado == 'A':
        ...
        salida = datetime.strptime(horaSalida, "%Y-%m-%d %H:%M:%S")

        # Calcular la diferencia en horas
        totalHoras = (salida - entrada).total_seconds() / 3600  # Convertir segundos a horas
